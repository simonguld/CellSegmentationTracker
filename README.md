...
This package is meant to ease, automate and improve the process of biological cell segmentation, tracking and subsequent (mostly biophysical) statistical analysis. It is being developed primarily as a tool for the biophysicists of the Niels Bohr Institute of the University of Copenhagen, but anyone is more than welcome to use it! It is based on the cell segmentation program <a align="left"><a href="https://www.cellpose.org/">Cellpose</a></a> and the Tracking program <a align="left"><a href="https://imagej.net/plugins/trackmate/">Trackmate</a></a>, without any of which this project would have been impossible. The purpose of the package is to do 3 things, which can be done together or separately:
...
3. Provide functions for statistical analysis like e.g. functions for calculating summary statistics and average feature values against time, as well as functions for estimating the density and velocity fields, the density fluctuations etc. Make it easy to save and plot results.
