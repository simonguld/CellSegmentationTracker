...
- **cellpose_dict:  (dict, default=dict())**
  - A dictionary containing additional parameters to pass to the Cellpose segmentation algorithm:
    ...
    - CELL_DIAMETER (positive float, default = 0.0): Estimate of the cell diameter in the image, in physical units. Enter the value ‘0.0’ to have cellpose automatically determine the cell size estimate.
