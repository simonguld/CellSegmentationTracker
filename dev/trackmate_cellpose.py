...
file_paths = []
file_paths.append('https://fiji.sc/samples/FakeTracks.tif' )
...
def run( image_file ):
    ...
    settings.trackerSettings = LAPUtils.getDefaultSegmentSettingsmap() #settings.trackerFactory.getDefaultSettings()#LAPUtils.getDefaultLAPSettingsMap()
